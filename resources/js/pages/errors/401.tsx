...
import { LogIn, ArrowLeft, ShieldAlert, Satellite } from 'lucide-react';
...
export default function Unauthorized() {
    ...
    return (
        <>
            <Head title="401 - No autorizado | MonitorMacga" />
            ...
            <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
                ...
                <div className="absolute inset-0">
                    ...
                    <div className="absolute top-60 right-60 w-1 h-1 bg-amber-400 rounded-full animate-pulse"></div>
                    ...
                    <div className="absolute top-1/2 right-1/3 w-24 h-24 border border-amber-400/10 rounded-full"></div>
                </div>
                ...
                <div className="relative z-10 min-h-screen flex items-center justify-center p-6">
                        ...
                        <div className="relative w-full h-full">
                            <div className={`absolute top-32 left-1/2 transform -translate-x-1/2 animate-arc-float transition-all duration-2000 ease-out ${isLoaded ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
                                <div className="relative">
                                    ...
                                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-20 h-20 bg-amber-400/10 rounded-full animate-ping"></div>
                                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-28 h-28 bg-amber-400/5 rounded-full animate-pulse"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className={`w-full max-w-2xl transition-all duration-1000 ease-out ${isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                        ...
                        {/* Contenido del error */}
                        <div className="relative bg-slate-900/95 backdrop-blur-xl rounded-2xl border border-amber-500/25 p-8 sm:p-12 shadow-2xl">
                            
                            {/* Icono de error */}
                            <div className="flex justify-center mb-6">
                                <div className="relative">
                                    <div className="absolute inset-0 bg-amber-500/20 rounded-full blur-xl animate-pulse"></div>
                                    <div className="relative bg-gradient-to-br from-amber-500/20 to-amber-600/20 border border-amber-400/30 rounded-full p-6">
                            ...
                            <div className="text-center mb-6">
                                <h2 className="text-8xl sm:text-9xl font-black text-transparent bg-gradient-to-r from-amber-400 via-amber-500 to-amber-600 bg-clip-text mb-4">
                                    401
                                </h2>
                                <div className="w-24 h-1 bg-gradient-to-r from-amber-500 to-cyan-400 mx-auto rounded-full"></div>
                            </div>
                            ...
                            <div className="text-center mb-8">
                                ...
                                <p className="text-blue-200/80 text-base sm:text-lg">
                                    Debes iniciar sesión para acceder a esta página. Tu sesión puede haber expirado.
                                </p>
                            </div>
